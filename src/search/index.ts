...
// //binarySearch ==> finde target insert the arr
// //divide the arr  // find mid el
// //if target is greater than mid

// const bianrySearch8 = (arr: number[], t: number) => {
//   let leftIndex = 0;
//   let rightIndex = arr.length - 1;
...
//   }
// };
// // console.log(bianrySearch8([2, 1, 3, 6, 5, 7], 7));

// const binarySearch5 = (arr: number[], target: number) => {
//   let startPoint = 0;
//   let endPoint = arr.length - 1;
...
//   }
// };
// // console.log(binarySearch5([2, 1, 3, 6, 5, 7], 7));

// //linear Search ==> finde el inside the arr
// const linearSearch6 = (arr: number[], target: number) => {
//   for (let i = 0; i <= arr.length; i++) {
//     if (target === arr[i]) {
//       return i;
//     }
...
// const binarySearchRecursive = (arr: number[], target: number) => {
...
//   if (target < arr[midPoint]) {
//     return search1(arr, target, startPoint, midPoint - 1);
//   } else {
//     return search1(arr, target, midPoint + 1, endPoint);
//   }
// };

// // linearSearch// find the el inside the array //

// const linearSearch5 = (arr: number[], target: number) => {
...
// linearSearch5([1, 2, 3, 4, 5, 8], 3);

// //binarySearch ==> must be sort and divide the arr , repeatly

// const binarySearch3 = (arr: number[], target: number) => {
//   let startPoint = 0;
//   let endPoint = arr.length - 1;
...
const recirsivebinarySearch4 = (arr: number[], target: number) => {
  return search4(arr, target, 0, arr.length - 1);
};
...
const search4 = (
  ...
  if (target < arr[midPoint]) {
    return search4(arr, target, startPoint, midPoint - 1);
  } else {
    return search4(arr, target, midPoint + 1, endPoint);
  }
};
...
const search = (
  ...
  if (target < arr[midPoint]) {
    return search(arr, target, startPoint, midPoint - 1);
  } else {
    return search(arr, target, midPoint + 1, endPoint);
  }
};
